...
urlpatterns = [
    ...
    path("api/profiles/<uuid:pk>/block/", BlockUserAPIView.as_view(), name="block-user"),
    ...
    path('api/products/by-gender/<int:gender_id>/', ProductListByGender.as_view(), name='product-list-by-gender'),
